...
export default function Home() {
  return (
    <div className="flex flex-1 w-full items-center justify-center dark:bg-black">
      <div className="flex flex-col gap-8 items-center justify-center bg-white dark:bg-black">
